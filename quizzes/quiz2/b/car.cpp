...
bool Car::getTopSpeedReached(){
    return topSpeedReached_;
}

bool Car::getStationaryState(){
    return carStationary_;
}
...
void Car::setTopSpeedReached(bool topSpeedReached){
    topSpeedReached_ = topSpeedReached;
}

void Car::setStationaryState(bool state){
    carStationary_ = state;
}
