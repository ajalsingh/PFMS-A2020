...
public:
    ...
    : nh_(nh), it_(nh)
    {
        ...
        sub2_ = nh_.subscribe("robot_0/path", 10, &PfmsSample::pathCallback,this);
        ...
        while (ros::ok()) {
            ...
            if(imageOK){
                ...
                if(pathArrayBuffer_.received){
                  ...
                  for (int i = 0; i < pathArrayBuffer_.poses.poses.size(); i++){
                      ...
                      double xD = (xpos/pathArrayBuffer_.resolution)+offset - 900;
                      double yD = (-ypos/pathArrayBuffer_.resolution)+offset - 900;
